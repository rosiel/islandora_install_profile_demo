  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL): array
  {
    ...
    if (!$datasource) {
      $rel_types = [
        ...
        ,"bnd" => "Binder (bnd)"
        ,"islandora_install_profile_demod" => "Binding designer (islandora_install_profile_demod)"
        ...
        ,"pbl" => "Publisher (pbl)"
        ,"pislandora_install_profile_demo" => "Publishing director (pislandora_install_profile_demo)"
        ,"ppt" => "Puppeteer (ppt)"
