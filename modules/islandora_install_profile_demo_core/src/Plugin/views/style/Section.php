...
namespace Drupal\islandora_install_profile_demo_core\Plugin\views\style;
 ...
 * @ViewsStyle(
 *   id = "carapace_details",
 *   title = @Translation("Carapace Details"),
 *   help = @Translation("Displays rows as details, supports nested groups."),
 *   theme = "views_view_carapace_details",
 *   display_types = {"normal"}
 * )
 */
class Section extends StylePluginBase {
  ...
  protected $groupingTheme = 'views_view_carapace_section_grouping';
