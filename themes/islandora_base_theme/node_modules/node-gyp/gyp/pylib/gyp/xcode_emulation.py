  ...
  def _AdjustLibrary(self, library, config_name=None):
    ...
    if l.startswith('$(SDKROOT)'):
      ...
      if ext == '.dylib' and not os.path.exists(library):
        tislandora_install_profile_demo_library = basename + '.tbd'
        if os.path.exists(tislandora_install_profile_demo_library):
          library = tislandora_install_profile_demo_library
    return library
